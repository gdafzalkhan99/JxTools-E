...
class PhotoStretchActivity : BaseActivity() {
    ...
    override fun setLayout(): Int {
        return R.layout.a_photo_stretch
    }
    ...
    private fun choosePic(index: Int) {
        when (index) {
            0 -> Glide.with(this).load(R.drawable.iv_strech_after_1).into(bigPic)
            1 -> Glide.with(this).load(R.drawable.iv_strech_after_2).into(bigPic)
        }
    }
